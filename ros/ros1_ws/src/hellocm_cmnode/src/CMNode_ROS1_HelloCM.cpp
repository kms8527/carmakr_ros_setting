...
cmnode_HelloCM_CB_TpcIn (const hellocm_msgs::Ext2CM::ConstPtr &msg)
{
    ...
    in->Msg.accel   = msg->accel;

//    DrivMan.Steering.Trq = msg->steer;
//    DrivMan.Gas = msg->accel;
...
CMRosIF_CMNode_Init (int Argc, char **Argv, char *CMNodeName, struct tInfos *Inf)
{
    ...
    CMNode.Topics.Sub.Ext2CM.flag        = 0;
...
//    LOG("bbbbbbbbbbb");
    ...
    LOG("steer = %.3fs, accel = %.3f",DrivMan.Steering.Ang , DrivMan.Gas);
    /* Put your code here */
